    ...
    <div class="container">
        <div class="col-md-4" style="background-color: #122b40">
            <form action="Controller" method="post">
                ...
                <%--                </div>--%>
                <%--                <br>--%>
                <input type="submit" class=" btn-primary btn-block " value=<fmt:message key="header.common.book_now"/> />
            </form>
            <br>
        </div>
...
<br><br><br>
<div class="container">
    <a href="Controller?command=GO_TO_MAIN_PAGE" button class="btn btn-primary  badge-pill"><fmt:message
