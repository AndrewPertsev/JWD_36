...
public class ApartmentDaoImpl implements ApartmentDao {
    ...
    public List<Apartment> findApartmentsSuitableForRequest(Request request) throws DAOException {
        ...
        try {
            ...
            statement.setString(1, String.valueOf(request.getStart()));
            statement.setString(2, String.valueOf(request.getEnd()));
            statement.setString(3, String.valueOf(request.getCategory()));
