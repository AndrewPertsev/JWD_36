...
public class OfferServiceImpl implements OfferServiceable {
    ...
    public Offer assembleOfferForApartment(int suitableApartmentId, int requestId) throws ServiceException {
        ...
        try {
            requestUsers = requestDao.findByid(requestId);
        } catch (DAOException e) {
        ...
        offer.setQuantity(requestUsers.getQuantity());
        offer.setTransfer(requestUsers.getTransfer());
        offer.setMenu(requestUsers.getMenu());
        offer.setApartmentId(suitableApartmentId);
        offer.setStart(requestUsers.getStart());
        offer.setEnd(requestUsers.getEnd());
